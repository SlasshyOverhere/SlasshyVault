...
export const ShareDialog = ({ open, onOpenChange, fileId, fileName }: ShareDialogProps) => {
  ...
  return (
    <Dialog open={open} onOpenChange={(o) => { if (!o) handleClose() }}>
      <DialogContent className="sm:max-w-md bg-[#090909]/95 backdrop-blur-2xl p-0 overflow-hidden border border-white/10 shadow-[0_0_120px_rgba(0,0,0,0.85)] rounded-[2rem]">
        ...
        <div className="px-6 pb-6">
          {shared ? (
            <div className="flex flex-col items-center gap-5 py-8">
              <div className="w-20 h-20 rounded-full bg-white/10 flex items-center justify-center ring-1 ring-white/20">
