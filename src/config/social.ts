...
export const SOCIAL_STORAGE_KEY = 'streamvault_social';
export const PROFILE_CACHE_KEY = 'streamvault_profile_cache';
export const SOCIAL_LAST_SYNC_KEY = 'streamvault_social_last_sync';
export const SOCIAL_SYNCED_ACTIVITY_KEYS_KEY = 'streamvault_social_synced_activity_keys';
export const SOCIAL_DEFAULT_SYNC_CURSOR = '1970-01-01 00:00:00';
export const MAX_SYNCED_ACTIVITY_KEYS = 1000;
export const DEV_SETTINGS_KEY = 'streamvault_dev_settings';
